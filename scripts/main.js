...
/**
 * Move the camera according to the distance scrolled.
 */
function moveCamera() {
  // Get distance from top of page to the current viewport
...
/**
 * Infinite loop that calls the render everytime the browser repaint
 * the screen.
 */
function animate() {
